...
@register_env("PullSmallerCube-v1", max_episode_steps=150)
@register_env("PullSmallerCubeSwapped-v1", max_episode_steps=150, larger_cube_color="blue")
class PullSmallerCubeEnv(BaseEnv):
    """
    **Task Description:**
    ...
    **Success Conditions:**
    ...
    def compute_dense_reward(self, obs: Any, action: torch.Tensor, info: Dict):
        ...
        tcp_pull_pose = Pose.create_from_pq(
            ...
            + torch.tensor([self.smaller_cube_half_size + 2 * 0.005, 0, 0], device=self.device)
        )
