...
DATA_PATHS = {
    "pick_larger": {
        ...
        "B": "./demos/PickSmallerCube-v1/motionplanning/pick_smaller_offlinerl_2000_state.state.pd_ee_delta_pose.physx_cpu.h5",
    },
    "push_larger": {
        "A": "./demos/PushLargerCube-v1/motionplanning/push_larger_offlinerl_2000_state.state.pd_ee_delta_pose.physx_cpu.h5",
        "B": "./demos/PushSmallerCube-v1/motionplanning/push_smaller_offlinerl_2000_state.state.pd_ee_delta_pose.physx_cpu.h5",
    },
    "place_larger": {
        "A": "./demos/PlaceLargerCube-v1/motionplanning/place_larger_offlinerl_2000_state.state.pd_ee_delta_pose.physx_cpu.h5",
        "B": "./demos/PlaceSmallerCube-v1/motionplanning/place_smaller_offlinerl_2000_state.state.pd_ee_delta_pose.physx_cpu.h5",
    },
    "pull_larger": {
        "A": "./demos/PullLargerCube-v1/motionplanning/pull_larger_offlinerl_2000_state.state.pd_ee_delta_pose.physx_cpu.h5",
        "B": "./demos/PullSmallerCube-v1/motionplanning/pull_smaller_offlinerl_2000_state.state.pd_ee_delta_pose.physx_cpu.h5",
    },
    "pick_larger_swapped": {
        "A": "./demos/PickLargerCubeSwapped-v1/motionplanning/pick_larger_offlinerl_2000_state.state.pd_ee_delta_pose.physx_cpu.h5",
        "B": "./demos/PickSmallerCubeSwapped-v1/motionplanning/pick_smaller_offlinerl_2000_state.state.pd_ee_delta_pose.physx_cpu.h5",
    },
    "push_larger_swapped": {
        "A": "./demos/PushLargerCubeSwapped-v1/motionplanning/push_larger_offlinerl_2000_state.state.pd_ee_delta_pose.physx_cpu.h5",
        "B": "./demos/PushSmallerCubeSwapped-v1/motionplanning/push_smaller_offlinerl_2000_state.state.pd_ee_delta_pose.physx_cpu.h5",
    },
    "place_larger_swapped": {
        "A": "./demos/PlaceLargerCubeSwapped-v1/motionplanning/place_larger_offlinerl_2000_state.state.pd_ee_delta_pose.physx_cpu.h5",
        "B": "./demos/PlaceSmallerCubeSwapped-v1/motionplanning/place_smaller_offlinerl_2000_state.state.pd_ee_delta_pose.physx_cpu.h5",
    },
    "pull_larger_swapped": {
        "A": "./demos/PullLargerCubeSwapped-v1/motionplanning/pull_larger_offlinerl_2000_state.state.pd_ee_delta_pose.physx_cpu.h5",
        "B": "./demos/PullSmallerCubeSwapped-v1/motionplanning/pull_smaller_offlinerl_2000_state.state.pd_ee_delta_pose.physx_cpu.h5",
    },
}
...
def main():
    ...
    while num_traj < NUM_TRAJ_PER_TASK:
        ...
        # start_idx_2 = random.randint(0, traj_len_2 - TRAJ_LEN - 1)
        ...
        # next_obs_2.append(f2[keys_2[i]]["obs"][start_idx_2 + 1:start_idx_2 + TRAJ_LEN + 1])
        # actions_2.append(f2[keys_2[i]]["actions"][start_idx_2:start_idx_2 + TRAJ_LEN])
        obs_2.extend(f2[keys_2[i]]["obs"][:-1])
        next_obs_2.extend(f2[keys_2[i]]["obs"][1:])
        actions_2.extend(f2[keys_2[i]]["actions"][:])
    ...
    total_num_transitions = actions_1.shape[0] + actions_2.shape[0]

    combined_obs = np.concatenate((obs_1, obs_2), axis=0)
    combined_next_obs = np.concatenate((next_obs_1, next_obs_2), axis=0)
    combined_action = np.concatenate((actions_1, actions_2), axis=0)
    # combined_reward = np.concatenate((rewards_1, rewards_2), axis=0)
    ...
    np.savez_compressed(
        f"data_offlinerl_{TASK}_{NUM_TRAJ_PER_TASK * 2}.npz", 
        obs=combined_obs, 
